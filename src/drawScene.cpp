...
DrawSceneTool::DrawSceneTool() : 
 _shader(Shader("resource/rect_vs.glsl", "resource/rect_fs.glsl")) {

}

bool DrawSceneTool::init(const string &filepath)
{
	float vertices[] = {
		//     ---- 位置 ----       ---- 颜色 ----     - 纹理坐标 -
